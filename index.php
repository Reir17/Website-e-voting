...
<head>
	...
	<link rel="icon" href="dist/img/FIFA-Logo.png">
	...
	<div class="wrapper">
			...
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item d-none d-sm-inline-block">
					<a href="index.php" class="nav-link">
						<b style="background-color: #1D79F2; color: white;">Sistem Pemungutan Suara Terdistribusi</b>
					</a>
				</li>
			</ul>
		...
		<aside class="main-sidebar sidebar-light-primary elevation-4">
			...
			<a href="index.php" class="brand-link">
				<img src="dist/img/FIFA-Logo.png" alt="AdminLTE Logo" class="brand-image" style="opacity: .8">
			...
			<div class="sidebar">
				...
				<div class="user-panel mt-3 pb-3 mb-3 d-flex">
					<div class="image">
						<img src="dist/img/Gianni-Infantino.png" class="img-circle elevation-2" alt="User Image">
					</div>
					<div class="info">
